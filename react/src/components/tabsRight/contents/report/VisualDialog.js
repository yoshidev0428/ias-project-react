...
const VisualDialog = () => {
    ...
    return (
        <>
            ...
            <Dialog open={DialogVisualFlag} onClose={close} overflow-y="hidden" maxWidth="750px" style={{height:'auto'}}>
            <div className='visual-dialog' >
                <div className="d-flex justify-content-center visual-title">
                    <DialogTitle>Visual</DialogTitle>
                    <button className="dialog-close-btn" style={{backgroundColor: 'white'}} color="primary" onClick={close}>&times;</button>
                </div>
                <div className='mx-3 my-2 d-flex align-items-center justify-content-center visual-toolbar' style={{ width: 750}}>
                    <VisualToolbar />
                </div>
