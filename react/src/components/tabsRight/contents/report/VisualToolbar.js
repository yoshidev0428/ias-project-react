    ...
    <Row style={{ width:'100%' }}>
      <Col xs={4}>
        <div className='d-flex justify-content-between visual-toolbar-buttons'>
          <button className="btn btn-sm pt-0 pb-0" style={{height: '35px'}} onClick={before}>
              <Icon size={1}
                  horizontal
                  vertical
                  rotate={180}
          ...
          <button className="btn btn-sm pt-0 pb-0" style={{height: '35px'}} onClick={next}>
              <Icon size={1}
                  horizontal
                  vertical
                  rotate={180}
          ...
          <button className="btn btn-sm pt-0 pb-0" style={{height: '35px'}} onClick={exit}>
              <Icon size={1}
                  horizontal
                  vertical
                  rotate={180}
          ...
          <button className="btn btn-sm pt-0 pb-0" style={{height: '35px'}} onClick={home}>
              <Icon size={1}
                  horizontal
                  vertical
                  rotate={180}
