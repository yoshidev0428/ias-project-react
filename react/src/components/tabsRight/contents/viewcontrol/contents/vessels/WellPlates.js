...
import { VESSEL_WELLPLATE_RATIO, VESSEL_WELLPLATE_MAX_HEIGHT, VESSEL_WELLPLATE_MAX_FONTSIZE } from '../../../../../constant/constants';
...
const WellPlates = (props) => {
    ...
    const handleVesselClick = (e, holeNumber, row, col) => {
        ...
        if (activeHoles.includes(holeNumber)) {
            ...
            store.dispatch({ type: "vessel_selectedVesselHole", content: { row: row, col: col + 1 } });
        }
        else {
