...
export default function WellPlates (props) {
    ...
    return (
        ...
        {
            CurrentVesselID === 7 && <div className="btn btn-md" type="button" style={{ boxShadow: "none"}}>
                <Image style={{ margin: '0 auto', width: width, height: height }} src={"../assets/images/6well.png"} alt='no image' />
            </div>
        }
        {
            CurrentVesselID === 8 && <div className="btn btn-md" type="button" style={{ boxShadow: "none"}}>
                <Image style={{ margin: '0 auto', width: width, height: height }} src={"../assets/images/12well.png"} alt='no image' />
            </div>
        }
        {
            CurrentVesselID === 9 && <div className="btn btn-md" style={{ boxShadow: "none"}}>
                <Image style={{ margin: '0 auto', width: width, height: height }} src={"../assets/images/24well.png"} alt='no image' />
            </div>
        }
        {
            CurrentVesselID === 10 && <div className="btn btn-md" type="button" style={{ boxShadow: "none"}}>
                <Image style={{ margin: '0 auto', width: width, height: height }} src={"../assets/images/48well.png"} alt='no image' />
            </div>
        }
        {
            CurrentVesselID === 11 && <div className="btn btn-md" type="button" style={{ boxShadow: "none"}}>
                <Image style={{ margin: '0 auto', width: width, height: height }} src={require("../assets/images/96well.png")} alt='no image' />
            </div>
        }
        {
            CurrentVesselID === 12 && <div className="btn btn-md" style={{ boxShadow: "none"}}>
                <Image style={{ margin: '0 auto', width: width, height: height }} src={"../assets/images/384well.png"} alt='no image' />
            </div>
        }
    </div>
    );
