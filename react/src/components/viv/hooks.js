...
export const useImage = (source) => {
    ...
    const [use3d, toggleUse3d, toggleIsOffsetsSnackbarOn, channelMap, tiffNames, experimentName] = 
        useViewerStore(store => [store.use3d, store.toggleUse3d, store.toggleIsOffsetsSnackbarOn, store.channelMap, store.tiffNames, store.experimentName], shallow);
