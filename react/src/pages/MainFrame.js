...
import { FIXED_BAR_HEIGHT } from '@/constants/design';
...
const MainFrame = () => {
  ...
  const handleResize = () => {
    ...
    localStorage.setItem('imageViewSizeHeight', height - FIXED_BAR_HEIGHT);
  };
  ...
  return (
    <>
      ...
      <Container
        fluid={true}
        className="p-0"
        style={{ height: (height - FIXED_BAR_HEIGHT).toString() + 'px' }}
      >
        <Row noGutters>
          <Col
            xs={2}
            ...
            style={{
              height: (height - FIXED_BAR_HEIGHT).toString() + 'px',
              overflowY: 'auto',
            }}
          >
