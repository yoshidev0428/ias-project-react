...
function rfft2d(data, m, n) {
  ...
  spectrum.set(
    new Float32Array(Module.HEAPU8.buffer, heapSpectrum.byteOffset, m * n * 2)
  );
...
function irfft2d(spectrum, m, n) {
  ...
  data.set(new Float32Array(Module.HEAPU8.buffer, heapData.byteOffset, m * n));
