...
import { guessRgb, useWindowSize, getSingleSelectionStats } from '@/viv/utils';
import { GLOBAL_SLIDER_DIMENSION_FIELDS } from '@/viv/constants';
...
const Controller = () => {
  ...
  console.log('channelOptions--------->' + JSON.stringify(channelOptions));
    ...
    <Menu maxHeight={viewSize.height}>
      ...
      <TabPanel value={tab} index={0}>
        ...
        {!isViewerLoading && !isRgb ? (
          <Grid className="d-flex">{channelControllers}</Grid>
        ) : (
